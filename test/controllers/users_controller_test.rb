...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user" do
    assert_difference("User.count") do
      post users_url, params: { user: { address: @user.address, city: @user.city, email: @user.email, first_name: @user.first_name, last_name: @user.last_name, phone: @user.phone, state: @user.state, zip: @user.zip } }
    end
